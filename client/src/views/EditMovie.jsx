...
import { PUT_MOVIE, FETCH_MOVIE, FETCH_ALL } from "../graphql";
  ...
  return (
    ...
    >
      ...
      <Card style={{ marginTop: "2%" }}>
        <h4 style={{ marginTop: "2%", marginLeft: "2%" }}>Edit Movie</h4>
        <Form style={{ margin: "2%" }} onSubmit={handlePutMovie}>
