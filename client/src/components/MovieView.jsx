...
import { DELETE_MOVIE, FETCH_ALL } from "../graphql";
...
function MovieView(props) {
  ...
  const onClickFavorites = () => {
    const favoriteMovies = favoritesVar();

    if (
      favoriteMovies.find(
        (favoriteMovie) => favoriteMovie._id === props.movie._id
      )
    ) {
      ...
      favoritesVar([...favoritesVar(), props.movie]);
